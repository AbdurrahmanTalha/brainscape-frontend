...
const Hero2 = () => {
    return (
        <>
            ...
            <div className="lg:flex flex-row-reverse justify-between mt-[90px] items-center">
                ...
                <div className="ml-[40px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30%" height="520" viewBox="0 0 651 523" fill="none">
