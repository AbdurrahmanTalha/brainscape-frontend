...
const Hero2 = () => {
    return (
       <>
       <h1 className="text-center text-white font-bold text-[40px] mt-[63px]">Master concepts in 15 minutes a day</h1>
       <p className="text-white text-center">Lorem ipsum dolor sit amet. Id dolor totam aut aperiam <br /> cumque sit officia perspiciatis. Hic quis exercitationem aut o</p>
