                        ...
                        <div>
                            <div className=" w-full mb-7">
                                ...
                                <input
                                    ...
                                    className="input rounded-md border-2 border-[#9D77EE] lg:w-[90%]  w-full text-xs font-medium "
                                />
                            </div>
                            <div className=" w-full mb-7">
                        ...
                        <div>
                            ...
                            <div className=" w-4/5 mt-7">
                                ...
                                <label className="custom-file-input-label">
                                    ...
                                    <div className="flex justify-start gap-2 items-center lg:w-[80%]  w-full px-4 py-2 cursor-pointer input rounded-md border-2 border-[#9D77EE] text-xs font-medium">
