                ...
                <div className="lg:mr-[154px] mt-[20px]">
                    <div>
                        ...
                        <p className="font-normal text-base course-details-p py-[20px] lg:w-1/2">
                            asdasdas das dasd asdas asdasdas d asdasdasd sdasd asdd asdasdasdasdasd asdad asdasdas
                            asdasdsd asdad asdasdasd asdadasdas dasdas dasd asdasdasd asdasdasdad
                        </p>
